...
Usage:
    nybbooks-tag                                       # reads data/processed/books_with_images.csv, tags.txt
...
def main():
    ...
    parser.add_argument("--output",     default="data/processed/books_tagged.csv",      help="Output CSV (default: data/processed/books_tagged.csv)")
