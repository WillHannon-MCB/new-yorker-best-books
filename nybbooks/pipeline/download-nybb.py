...
Usage:
    nybbooks-download                                    # reads data/processed/books-nybb.csv
...
def main():
    ...
    parser.add_argument("--input",      default="data/processed/books-nybb.csv",        help="Input CSV (default: data/processed/books-nybb.csv)")
    parser.add_argument("--output",     default="data/processed/books-nybb-images.csv", help="Output CSV (default: data/processed/books-nybb-images.csv)")
